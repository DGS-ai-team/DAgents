...
本文从 **产品/能力** 视角汇总 **DAgents 后端** 当前已落地能力与后续演进路线，重点对齐 **企业本地 Agent 控制台 + 可治理 Skill Library** 的产品定位。版本细节以 **[CHANGELOG.md](../CHANGELOG.md)** 为准，契约类说明见 **[doc/README.md](./README.md)**。**0.x** 阶段仍允许 HTTP/OpenAPI/配置形态调整；本文件会随里程碑持续更新。
...
| 项 | 说明 |
|----|------|
| **`doc/cases/` 案例正文** | 目录与约定已就绪；后续案例应优先围绕企业本地闭环、触发器驱动诊断、审批修复和 skill 沉淀。 |
