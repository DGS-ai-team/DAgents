> **已归档**：本文描述已移除的 **Python FastAPI Agent** 上下文模型。现网压缩见 [design/major-changes.md](../../design/major-changes.md#1-上下文压缩与-prompt-cache-对齐m2--m3) 与 `node/internal/compression/`。
