...
**状态（2026-07）**：**`v0.6.0` 已发布**；当前开发 **`v0.6.1`**（**产品化 Web UI** + `show_image` + Media API）。  
...
完整 Smoke 见 [web-ui-redesign-v0.6.1.md §10](./web-ui-redesign-v0.6.1.md#10-验收smoke-扩展tag-v061)。

1. 默认布局无 SSE/API 常驻；诊断可折叠  
2. 工具一行摘要，可展开；Enter 发送  
3. `show_image` / browser 截图可见；F5 后仍在  
...
| 2026-07 | **v0.6.1 扩充**：Web UI 产品化重构（F-UI*）；见 [web-ui-redesign-v0.6.1.md](./web-ui-redesign-v0.6.1.md) |
