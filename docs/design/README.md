...
| **[workgroup-and-node-gateway.md](./workgroup-and-node-gateway.md)** | **现行产品规范**：工作组 + Timeline/RunHistory；D0.9/D1 完成；D2 Worker 进行中 |
| **[workgroup-d05-contracts.md](./workgroup-d05-contracts.md)** | **D0.5 已冻结（§19 A）**：schema / 状态机 / fixtures |
