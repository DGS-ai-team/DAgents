...
> **状态**：**产品方向冻结；D0.5 契约已冻结** — 见 [`workgroup-d05-contracts.md`](./workgroup-d05-contracts.md)（§19 Verdict A）；**D0.9–D4 已完成**；**D5 进行中**（Cut3：Edge 升级停用 + remote stub 列表隐藏/访问 410；Manage edge 包与 DELETE 仍保留）  
...
| **D5** | 拆除 Placement/Edge/remote stub/沙箱产品路径；拆旧 A2A — **进行中**（Cut1–3：停广告、peers/UI 死路径拆除、Edge 升级停用与 remote stub 产品面 410；Manage `/edge` 与 DELETE 仍保留） |
