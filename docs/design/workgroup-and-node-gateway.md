...
> **状态**：**产品方向冻结；D0.5 契约已冻结** — 见 [`workgroup-d05-contracts.md`](./workgroup-d05-contracts.md)（§19 Verdict A）；**D0.9–D4 已完成**；**D5 进行中**（Cut6：列表自动归档 remote stub；Edge/sandbox remote 已拆；Control DELETE 仍保留）  
...
| **D5** | 拆除 Placement/Edge/remote stub/沙箱产品路径；拆旧 A2A — **进行中**（Cut1–6：停广告、死路径、remote stub 410、Edge 拆除、sandbox remote 拒写、**列表自动 SoftDelete remote stub**；Control DELETE / 内部 placement 410 / 旧 A2A 仍保留） |
