...
> **状态**：**产品方向冻结；D0.5 契约已冻结** — 见 [`workgroup-d05-contracts.md`](./workgroup-d05-contracts.md)（§19 Verdict A）；**D0.9 / D1 / D2 / D3 基座已完成**；下一阶段 **D4**（多 Node 订阅 + 最小 UI）  
...
| **D4** | 多 Node 订阅与最小 UI 分栏；Node 默认挂载 Workgroup Dialer |
