...
| 阶段 | 状态 | 说明 |
|------|------|------|
| **0.9.1** | **预览准备中** | Workgroup 可演示；验收见 [v0.9.1-smoke-checklist.md](./design/v0.9.1-smoke-checklist.md)。正式版前最后一个大预览。 |
...
**最后更新**：2026-08-06 — 对齐 v0.9.1 预览（Web UI + Workgroup）；去掉 TUI / A2A / 沙箱主路径叙述。
