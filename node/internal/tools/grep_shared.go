...
func grepFileContentAtPath(absPath, displayPath string, lines []string, re *regexp.Regexp, opt lineSearchOptions) (string, error) {
...
func (r *Registry) grepSingleFile(relPath string, re *regexp.Regexp, opt lineSearchOptions) (string, error) {
	...
	return grepFileContentAtPath(absPath, relPath, lines, re, opt)
}
