...
| **工具链上下文成本** | 减少轮询、tool 结果膨胀、schema 前缀扰动；WS1 先行 bash job long-poll | [major-changes.md §2](docs/design/major-changes.md#2-工具链上下文成本优化规划中) · [完整分析](docs/design/tool-context-cost-analysis.md) |
