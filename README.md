...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/release-v0.9.16-green" alt="v0.9.16"></a>
...
当前版本为 **v0.9.16**（基于 **v0.9.1** 预览线的稳定性补丁；含工具上下文与 schema 优化、skills 目录注入优化、附件与图片预览、多厂商 LLM、终端执行、MCP 接入、工作组协作与 Node Web UI 优化）。能力边界与验收步骤见手册中的 [预览清单](docs/design/v0.9.1-smoke-checklist.md)。
