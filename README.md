...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/release-v0.9.13-green" alt="v0.9.13"></a>
...
当前版本为 **v0.9.13**（基于 **v0.9.1** 预览线的稳定性补丁；含多厂商 LLM、模型级思考参数、终端执行、MCP 接入、工作组协作与 Node Web UI 优化）。能力边界与验收步骤见手册中的 [预览清单](docs/design/v0.9.1-smoke-checklist.md)。
