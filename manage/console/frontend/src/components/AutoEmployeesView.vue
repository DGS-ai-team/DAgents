...
@media (max-width: 760px) { .auto-employees-table { display: none; } .auto-employees-cards { display: grid; gap: 10px; } .auto-employee-card { display: grid; gap: 8px; padding: 14px; border: 1px solid var(--border-subtle); border-radius: 12px; background: var(--surface-raised); } .auto-employee-card small { color: var(--text-secondary); } .auto-employee-card p { margin: 0; overflow-wrap: anywhere; } .panel-toolbar { align-items: stretch; flex-wrap: wrap; } }
</style>
